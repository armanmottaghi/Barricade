...
classdef Robotarium < ARobotarium
    ...
    methods
        ...
        function this = Robotarium(number_of_agents, save_data, show_figure, initial_poses, number_of_enemies, number_of_defenders, CapturedEnemy,EnvironmentalParameters, DefenderController, EnemyController,boundaries,boundary_points)
            this = this@ARobotarium(number_of_agents, save_data, show_figure, initial_poses,  number_of_enemies, number_of_defenders, CapturedEnemy,EnvironmentalParameters, DefenderController, EnemyController,boundaries,boundary_points );
        ...
        function CapturedEnemy = get_captured_enemy(this)
        ...
        function step(this)
            ...
            total_time = this.EnvironmentalParameters.TimeStep;
            ...
            %disp(cos(this.poses(3, i)));
            %disp(sin(this.poses(3, i)));
